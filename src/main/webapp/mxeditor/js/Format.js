...
DiagramFormatPanel.prototype.init = function()
{
	...
	if (graph.isEnabled())
	{
		...
		this.container.appendChild(this.addSubmitBtn(this.createPanel()));
	}
};
...
/**
 * Adds Btn to Send data Models to Server
 */
DiagramFormatPanel.prototype.addSubmitBtn = function(div) {
	var btn = mxUtils.button(mxResources.get('getModel'), mxUtils.bind(this, function(evt)
	{
		this.editorUi.actions.get('getModel').funct();
	}));
	btn.setAttribute('title', mxResources.get('getModel') + ' (' + this.editorUi.actions.get('getModel').shortcut + ')');
	btn.style.width = '202px';
	div.appendChild(btn);
